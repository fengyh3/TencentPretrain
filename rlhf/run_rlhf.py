...
def main():
    ...
    parser.add_argument("--data_processor",
                        choices=["bert", "lm", "mlm", "bilm", "albert", "mt", "t5", "cls",
                                 ...
                                 "s2t", "beit", "dalle", "alpaca", "reward"], default="bert",
    ...
    # data loader
    train_loader = str2dataloader[args.data_processor](args, args.dataset_path, args.batch_size, rank, args.world_size,
                                                       gpu_id, True)
    ...
    # trainer loader
    trainer = PPOTrainer(args, rlhf_engine, train_loader)
